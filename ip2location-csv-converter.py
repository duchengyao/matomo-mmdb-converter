            ...
            for row in mycsv:
                ...
                if (write_mode == 'replace'):
                    ...
                    if remaining_columns == '':
                        ...
                        new_row = '"' + row[0] + '","' + row[
                            1] + '","' + from_ip + '","' + to_ip + '","' + remaining_columns
                    # print (new_row)
                ...
                if (write_mode == 'replace'):
                    ...
                    if sys.version < '3':
                        ...
                        if remaining_columns == '':
                            ...
                            new_row = '"' + str(from_hex.decode('utf-8')) + '","' + str(
                                to_hex.decode('utf-8')) + '","' + remaining_columns
                    # print (new_row)
                elif (write_mode == 'append'):
                    # new_row = '"' + row[0] + '","' + row[1] + '","' + from_ip + '","' + to_ip + '","' + remaining_columns
                    if sys.version < '3':
                        if remaining_columns == '':
                            ...
                            new_row = '"' + row[0] + '","' + row[
                                1] + '","' + from_hex + '","' + to_hex + '","' + remaining_columns
                    else:
                        if remaining_columns == '':
                            new_row = '"' + row[0] + '","' + row[1] + '","' + str(
                                from_hex.decode('utf-8')) + '","' + str(to_hex.decode('utf-8')) + '"'
                        else:
                            new_row = '"' + row[0] + '","' + row[1] + '","' + str(
                                from_hex.decode('utf-8')) + '","' + str(
                                to_hex.decode('utf-8')) + '","' + remaining_columns
                    # print (new_row)
                # writetofile(output_file, new_row)
                if sys.version < '3':
